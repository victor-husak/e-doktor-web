...
export const PointsItem: React.FC<PointsItemProps> = (
  props,
): React.JSX.Element => {
  return (
    <div
    ...
    >
      ...
      {/* Title */}
      <span className="link-dashed mb-md text-[15px]/[18px] font-semibold tracking-[-.018em] text-[#716DE3] [--link-dashed-border-color:#716DE3]">
        {props.title}
      </span>
