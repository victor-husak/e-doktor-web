...
export const HomeDomain: React.FC<HomeDomainProps> = (
  ...
  return (
    <div className={clsx(props.className, "")}>
      ...
      <Points className={clsx("hidden", "lg:grid")} />

      <Healthcare className="border-border border-b pb-[90px]" />
      ...
      <Suite reverse translation="pages.home.connect" items={connectSuite} />

      <Servises />

      <Features className="mb-[50px]" />
    </div>
  );
};
